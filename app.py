...
with news_section:
    ...
    if st.session_state.crypto == 'Bitcoin':
        ...
        about_desc = "Ethereum is a Proof-of-Stake blockchain that powers decentralized applications through smart contracts, without being controlled by a centralized entity. As the first blockchain to feature smart contracts, it has the largest ecosystem of decentralized applications, ranging from decentralized exchanges to crypto lending and borrowing platforms and more."
    else:
