...
def open_options():
    ...
    with select:
        ...
        selection = st.segmented_control(label="**CHOOSE A CRYPTOCURRENCY**", options=options, selection_mode="single", default=st.session_state.crypto, use_container_width=True)
