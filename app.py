...
with info:
    ...
    with sub_info2:
        ...
        st.markdown(f"<h4 style='text-align: left; font-size: 1rem; font-weight: 500; line-height: 0.5; text-align: right color: #AFFD86'><a href='{st.session_state.website}'>{st.session_state.website}</a></h4>", unsafe_allow_html=True)
with chart:
    # PRICE CHART
