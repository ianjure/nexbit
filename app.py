...
with info:
    ...
    price_change = f"""
        <div style="display: flex; justify-content: flex-start; align-items: center;">
            ...
            <span padding: 0 10px; vertical-align: -5px; color: #8DFB4E;">
                <i class="material-icons" style="font-size: 3rem;">arrow_drop_up</i> 
            </span>
            <h4 style="font-size: 1.2rem; font-weight: 700; margin: 0; vertical-align: -5px; color: #8DFB4E;">
                0.5%
            </h4>
        </div>
        <style>
