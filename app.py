...
with info:
    ...
    price_change = f"""
        <div style="display: flex; justify-content: flex-start; align-items: center;">
            ...
            <span padding: 0px; display: flex; align-items: center; height: 100%;"">
                <i class="material-icons" style="font-size: 2rem; vertical-align: middle; color: #8DFB4E;">arrow_drop_up</i> 
            </span>
            <h4 style="font-size: 1.2rem; font-weight: 700; margin: 0; color: #8DFB4E;">
                0.5%
            </h4>
        </div>
        <style>
