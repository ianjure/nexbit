...
with info:
    ...
    with sub_info1:
        st.markdown(f"<div><h4 style='text-align: left; font-size: 1rem; font-weight: 500; line-height: 0.5;'>TOTAL SUPPLY:</h4><h4 style='text-align: left; font-size: 1rem; font-weight: 500; line-height: 0.5; text-align: right'>Tasdasdwasd</h4></div>", unsafe_allow_html=True)
